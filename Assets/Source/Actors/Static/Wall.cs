...
namespace DungeonCrawl.Actors.Static
{
    public class Wall : Actor
    {
        ...
        public Dictionary<string, int> SpriteVariants = new Dictionary<string, int>()
        {
            ...
            {"woodenObstacle", 251}, {"crown", 139}, {"crossUp", 600}, {"crossDown", 648}, {"door2", 340}, {"entrance", 1}, 
            ...
            {"greenLeft", 815 }, {"greenRight", 817 }, {"greenUp", 768}, {"greenDown", 864}, {"houseDoor", 778}, {"houseWall", 777}, {"houseWall1", 779}
        };
